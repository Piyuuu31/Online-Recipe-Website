...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <a class="text-decoration-none" href="recipedetails.php">
